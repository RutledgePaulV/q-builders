...
public class ElasticsearchVisitorTest extends QBuilderTestBase<Elasticsearch2Visitor, QueryBuilder> {
    ...
    @Override
    protected Elasticsearch2Visitor getVisitor() {
        return new Elasticsearch2Visitor();
    }

    @Override
    protected void compare(String expected, QueryBuilder converted) {
