...
public class ESQBuilderTest
        extends QBuilderTestBase<ElasticsearchFilterVisitor, org.elasticsearch.index.query.FilterBuilder> {
    ...
    @Override
    protected ElasticsearchFilterVisitor getVisitor() {
        return new ElasticsearchFilterVisitor();
    }
