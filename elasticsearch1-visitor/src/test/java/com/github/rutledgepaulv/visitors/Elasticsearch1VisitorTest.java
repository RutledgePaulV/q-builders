...
public class Elasticsearch1VisitorTest extends QBuilderTestBase<Elasticsearch1Visitor, FilterBuilder> {

    public Elasticsearch1VisitorTest() {
    ...
    @Override
    protected Elasticsearch1Visitor getVisitor() {
        return new Elasticsearch1Visitor();
    }
